                        ...
                        <div class="table-responsive">
                            <table id="usersTable" class="table table-bordered table-hover align-middle">
                                ...
                                <tbody>
                                    ...
                                    @forelse($gallery as $glr)
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="ids[]" value="{{ $glr->id }}"
                                                class="rowCheckbox">
                                            {{ $loop->iteration }}
                                        </td>
                                        ...
                                        <td>
                                            @if($glr->image)
                                            <img src="{{ asset('storage/'.$glr->image) }}" width="50" height="50"
                                        ...
                                        <td>
                                            <a href="{{ route('gallery.edit', $glr->id) }}"
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="5" class="text-center text-muted">No Image found</td>
                                    </tr>
                                    @endforelse
